...
print(time.strftime('%Y-%m-%d %H:%M:%S')+ "  :time made")
...
print(time.strftime('%Y-%m-%d %H:%M:%S')+ "  :creative_id made")
...
print(time.strftime('%Y-%m-%d %H:%M:%S')+ "  :ad_id made")
...
print(time.strftime('%Y-%m-%d %H:%M:%S')+ "  :advertiser_id made")
...
print(time.strftime('%Y-%m-%d %H:%M:%S')+ "  :industry made")
...
print(time.strftime('%Y-%m-%d %H:%M:%S')+ "  :product_id made")
...
print(time.strftime('%Y-%m-%d %H:%M:%S')+ "  :product_category made")
