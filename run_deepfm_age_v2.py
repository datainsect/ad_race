...
list_features = [ 'ad_id','advertiser_id','time']
...
checkpoint = ModelCheckpoint('models/gender_v2.h5', save_weights_only=False, save_best_only=True)
...
model.save('models/gender_v2_final.h5')
