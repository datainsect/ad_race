...
#1.1 time sequence 91 91
k = 92
term = 'time'
user_time = pd.read_csv(user_time_path)
user_time[term] = user_time[term].apply(lambda x : map(lambda y : int(y%k),list(eval(x))))
...
user_creative_id[term] = user_creative_id[term].apply(lambda x : map(lambda y : int(y%k),list(eval(x))))
...
user_ad_id[term] = user_ad_id[term].apply(lambda x : map(lambda y : int(y%k),list(eval(x))))
...
user_advertiser_id[term] = user_advertiser_id[term].apply(lambda x : map(lambda y : int(y%k),list(eval(x))))
...
user_industry[term] = user_industry[term].apply(lambda x : map(lambda y : int(y%k),list(eval(x))))
...
user_product_id[term] = user_product_id[term].apply(lambda x : map(lambda y : int(y%k),list(eval(x))))
...
user_product_category[term] = user_product_category[term].apply(lambda x : map(lambda y : int(y%k),list(eval(x))))
