...
checkpoint = ModelCheckpoint('models/deepfm4_gender_200.h5', save_weights_only=False, save_best_only=True)
callbacks_list = [checkpoint]

model = DeepFM(sparse_features, list_features,features_num_dict,k=10,list_k=200).model
...
model.save('models/deepfm4_gender_200_final.h5')