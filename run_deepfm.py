...
'time_len':max_len,'time_size':7779,'creative_id_len':max_len,'creative_id_size':8200,'ad_id_len':max_len,'ad_id_size':101,'advertiser_id_len':max_len,'advertiser_id_size':7779,'industry_len':max_len,'industry_size':7779,'product_id_len':max_len,'product_id_size':7779,'product_category_len':max_len,'product_category_size':7779,
}
...
raw_df = pd.merge(raw_df,user_sequence)
